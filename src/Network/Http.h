...
#ifndef __SOLAR_HTTP_H__
#define __SOLAR_HTTP_H__
...
public:
    ...
    const MapType& getParams() const { return m_headers; }
    ...
    std::string getCookie(const std::string& key, const std::string& default_val= "");
    ...
    template<typename T>
    bool checkParamAs(const std::string& key, T& val, const T& default_val = T{}) {
        return checkGetAs(m_params, key, val, default_val);
    }

    template<typename T>
    T getParamAs(const std::string& key, T& val, const T& default_val = T{}) {
        return getAs(m_params, key, val, default_val);
    }
    template<typename T>
    bool checkCookieAs(const std::string& key, T& val, const T& default_val = T{}) {
        return checkGetAs(m_cookies, key, val, default_val);
    }

    template<typename T>
    T getCookieAs(const std::string& key, T& val, const T& default_val = T{}) {
