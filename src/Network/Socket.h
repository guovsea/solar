...
#ifndef __SOLAR_SOCKET_H__
#define __SOLAR_SOCKET_H__
...
public:
    ...
    static Socket::ptr CreateTCP(solar::Address::ptr address);
    static Socket::ptr CreateUDP(solar::Address::ptr address);
    ...
    bool connect(const Address::ptr addr, uint64_t timeout_ms = ~0ul);
